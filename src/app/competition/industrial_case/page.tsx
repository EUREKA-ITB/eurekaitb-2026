...
export default function IndustrialCasePage() {
  ...
  const info = { 
    type: "Kelompok (Maks 3 Orang)", 
    desc: "Industrial Case Competition EUREKA 2026 adalah ajang studi kasus industri nyata bagi mahasiswa S1 di seluruh Indonesia. Uji kemampuan analisis dan strategi tim kamu dalam memecahkan masalah industri modern." 
  };

  const documents = [
    { id: "guidebook", title: "Guidebook Resmi", url: "/guidebooks/industrial_case.pdf" },
    { id: "format_pitchdeck", title: "Format Pitch Deck", url: "/guidebooks/format_pitch_ic.pdf" },
  ];
  ...
  const timelineData = [
    { date: "12 Nov - 10 Feb", title: "Registrasi & Pendaftaran", desc: "Pendaftaran peserta dan pembagian kasus awal secara online." },
    { date: "28 Feb 2026", title: "Pengumuman Finalis", desc: "Pengumuman tim terbaik yang berhak mempresentasikan solusinya." },
    { date: "2 - 4 Mei 2026", title: "Presentasi Final", desc: "Pitching solusi secara langsung di hadapan juri di Kampus ITB Ganesha." },
  ];

  const faqData = [
    { q: "Apakah kompetisi ini terbuka untuk semua jurusan kuliah?", a: "Ya, kompetisi ini terbuka untuk seluruh mahasiswa aktif S1 dari berbagai jurusan di Indonesia." },
    { q: "Apakah anggota kelompok boleh beda kampus?", a: "Tidak diperbolehkan. Seluruh anggota harus berasal dari perguruan tinggi yang sama." },
  ];
