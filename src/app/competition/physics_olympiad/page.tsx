    ...
    <div className="min-h-screen bg-blue-marine text-white font-sans overflow-x-hidden pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 w-full flex flex-col gap-16">
        ...
        <section className="relative z-10 py-10">
          ...
          <p className="text-center text-xs text-silver-shine mt-8 max-w-2xl mx-auto">*Seluruh peserta yang mengikuti babak penyisihan akan menerima sertifikat elektronik, sementara peserta yang berhasil lolos ke babak final akan memperoleh sertifikat fisik.</p>
        </section>
