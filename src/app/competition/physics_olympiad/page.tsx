...
// Tipe Data agar TypeScript tidak protes 'any'
...
export default function PhysicsOlympiadPage() {
  ...
  const lombaId = "physics_olympiad"; 
  ...
  const documents = [
    { id: "guidebook", title: "Guidebook Olimpiade", url: "/guidebooks/physics_olympiad.pdf" },
    { id: "silabus", title: "Silabus & Kisi-Kisi", url: "/guidebooks/silabus_physics_olympiad.pdf" },
  ];
  ...
  const timelineData = [
    { date: "16 - 29 Agustus 2026", title: "Registrasi Gelombang 1", desc: "Pendaftaran peserta dan verifikasi berkas secara online" },
    { date: "30 Agustus 2026 - 19 September 2026", title: "Registrasi Gelombang 2", desc: "Pendaftaran peserta dan verifikasi berkas secara online" },
    { date: "20 - 30 September 2026", title: "Registrasi Gelombang 3", desc: "Pendaftaran peserta dan verifikasi berkas secara online" },
    { date: "10 Oktober 2026", title: "Babak Penyisihan", desc: "Dilaksanakan serentak secara daring melalui platform CBT" },
    { date: "31 Oktober 2026", title: "Babak Semifinal", desc: "Dilaksanakan serentak secara daring melalui platform CBT" },
    { date: "28 - 29 November 2026", title: "Babak Final dan Grand Final", desc: "Dilaksanakan secara luring di Kampus ITB Ganesha" },
  ];

  const faqData = [
    { q: "Apakah diperbolehkan mendaftar Physics Olympiad dan cabang lomba lain sekaligus?", a: "Boleh, asalkan jadwal tahapan lomba tidak bentrok satu sama lain." },
    { q: "Apakah peserta yang lolos ke babak final wajib hadir langsung di ITB?", a: "Ya, untuk babak final dan grand final diwajibkan hadir secara luring di Kampus ITB Ganesha." },
  ...
  const hadiah = { juara1: "Rp 5.000.000", juara2: "Rp 3.500.000", juara3: "Rp 2.000.000" };
