...
// ==========================================
// ⚙️ PENGATURAN LINK (EDIT DI SINI SAJA!)
// ==========================================
const LINK_DATA = [
  {
...
export default function LinksPage() {
  return (
    <div className="min-h-screen bg-blue-marine text-white font-sans flex flex-col items-center py-20 px-6 relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="w-full max-w-lg z-10 flex flex-col items-center">
        ...
        <h1 className="font-display text-3xl font-bold mb-2 tracking-widest text-center">EUREKA<span className="text-sunlight-orange">2026</span></h1>
        <p className="text-silver-shine text-sm mb-10 text-center max-w-xs">
          Exploring Physics. Dari rasa ingin tahu menjadi dampak nyata.
        </p>
        ...
        {/* Social Media Footer (Ganti bagian ini) */}
