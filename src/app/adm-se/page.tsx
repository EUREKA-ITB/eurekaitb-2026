...
export default async function AdminSideEventPage() {
  ...
  return (
    <div className="min-h-screen bg-blue-marine text-white pt-28 pb-20 px-4 sm:px-6 relative overflow-x-hidden w-full">
      ...
      <div className="max-w-6xl mx-auto relative z-10 w-full overflow-hidden">
        <div className="mb-10 w-full">
          ...
          <h1 className="font-display font-bold text-3xl sm:text-4xl text-white mb-2 break-words">
          ...
          <div className="mt-6 flex gap-3 sm:gap-4 items-start bg-blue-500/10 border border-blue-500/20 p-4 sm:p-5 rounded-2xl max-w-3xl backdrop-blur-sm w-full overflow-hidden">
            <Info className="text-blue-400 shrink-0 mt-0.5" size={20} />
            <div className="min-w-0 flex-1">
              <h3 className="font-bold text-blue-400 text-sm mb-1 truncate">Penting: Aturan Upload Gambar</h3>
              <p className="text-silver-shine text-xs sm:text-sm leading-relaxed break-words">
